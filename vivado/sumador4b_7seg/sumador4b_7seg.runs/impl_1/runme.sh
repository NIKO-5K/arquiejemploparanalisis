...
HD_PWD='D:/vivado/sumador4b_7seg/sumador4b_7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum4b_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sum4b_7seg.tcl -notrace
