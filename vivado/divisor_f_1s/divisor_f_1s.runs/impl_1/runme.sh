...
HD_PWD='D:/vivado/divisor_f_1s/divisor_f_1s.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log div_f1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source div_f1.tcl -notrace
