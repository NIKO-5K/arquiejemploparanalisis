...
HD_PWD='D:/vivado/divisor_f_1s/divisor_f_1s.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_f1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div_f1.tcl
