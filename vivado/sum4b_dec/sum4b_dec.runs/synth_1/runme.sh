...
HD_PWD='D:/vivado/sum4b_dec/sum4b_dec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum4bdec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum4bdec.tcl
