...
HD_PWD='D:/vivado/sum4b_dec/sum4b_dec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum4bdec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sum4bdec.tcl -notrace
