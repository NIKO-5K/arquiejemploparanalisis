...
HD_PWD='D:/vivado/sumador1b/sumador1b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador1b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sumador1b.tcl -notrace
