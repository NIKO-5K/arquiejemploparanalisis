...
HD_PWD='D:/vivado/contador/contador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log contador16b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source contador16b.tcl
