...
HD_PWD='D:/vivado/contador/contador.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log contador16b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source contador16b.tcl -notrace
