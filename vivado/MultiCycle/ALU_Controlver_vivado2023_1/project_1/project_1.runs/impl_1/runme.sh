...
HD_PWD='/media/usb/vivado/MultiCycle/ALU_Control/ALU_Control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_Control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_Control.tcl -notrace
