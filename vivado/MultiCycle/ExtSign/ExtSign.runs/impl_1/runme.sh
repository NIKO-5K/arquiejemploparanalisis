...
HD_PWD='D:/vivado/ExtSign/ExtSign.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ExtSig.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ExtSig.tcl -notrace
