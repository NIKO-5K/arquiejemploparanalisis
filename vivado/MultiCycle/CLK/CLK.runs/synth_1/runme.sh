...
HD_PWD='/media/usb/vivado/MultiCycle/CLK/CLK.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLK.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLK.tcl
