...
HD_PWD='/media/usb/vivado/MultiCycle/CLK/CLK.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CLK.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CLK.tcl -notrace
