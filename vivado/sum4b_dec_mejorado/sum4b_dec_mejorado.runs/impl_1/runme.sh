...
HD_PWD='D:/vivado/sum4b_dec_mejorado/sum4b_dec_mejorado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum4bdec_mej.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sum4bdec_mej.tcl -notrace
