...
HD_PWD='D:/vivado/sum4b_dec_mejorado/sum4b_dec_mejorado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum4bdec_mej.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum4bdec_mej.tcl
