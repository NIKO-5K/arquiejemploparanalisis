...
HD_PWD='D:/vivado/circuitos/circuitos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4_1_32b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux4_1_32b.tcl
