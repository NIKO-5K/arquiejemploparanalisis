...
HD_PWD='D:/vivado/circuitos/circuitos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4_1_32b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux4_1_32b.tcl -notrace
