...
HD_PWD='D:/vivado/sumador4b_form/sumador4b_form.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador4b_f.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumador4b_f.tcl
