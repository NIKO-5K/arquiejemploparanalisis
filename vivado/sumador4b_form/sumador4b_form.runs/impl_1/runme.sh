...
HD_PWD='D:/vivado/sumador4b_form/sumador4b_form.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador4b_f.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sumador4b_f.tcl -notrace
